...
<figure>
  <img src="images/download-circ.png" alt="Trulli" style="width:7% margin: 25px 0px 25px 200px"">
  <figcaption>Baixar o ISSU</figcaption>
</figure>
...
2)  **Extraia** o arquivo ***intel-ssu-windows.zip;***

3)  **Navegue até a pasta da extração e execute** o arquivo ***intel-ssu-windows.exe***. Caso apareça uma mensagem do sistema "Deseja permitir que este aplicativo faça alterações no seu dispositivo?", clique em "Sim". Será aberta a janela do ***ISSU***.
